...
const userJobText = document.querySelector('.user-info__job');

const createCardForm = document.forms.new;
const CCFNameInput = createCardForm.name;
const CCFLinkInput = createCardForm.link;
